				...
				style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInUp;">
				  ...
				  style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInUp;">
					  ...
					  <div class="form-check">
						  <input class="form-check-input" type="radio" name="checked" value="1" id="checked1" ${dto.checked == 1 ? 'checked' : ''}>
						  <label class="form-check-label" for="checked1">
							  설정
						  </label>
					  </div>
					  <div class="form-check">
						  <input class="form-check-input" type="radio" name="checked" value="0" id="checked2" ${dto.checked == 0 ? 'checked' : ''}>
