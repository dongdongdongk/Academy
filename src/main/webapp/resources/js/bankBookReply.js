...
form1.append("bookNum", $("#replyAdd").attr('data-book-num'))//<form><input type="text" name="contents" value="dfds"><input type="text" name="bookNum" value="123"></form>


fetch('../productComment/add', {
    method:'POST',
    //headers:{},
    body:form1,
...
fetch("/productComment/list?num="+replyAdd.getAttribute('data-book-num')+"&page="+page, {
    method:'GET'
